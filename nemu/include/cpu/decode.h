...
typedef struct Decode {
  ...
  ISADecodeInfo isa;  //struct riscv64_ISADecodeInfo, the only member is inst(union).val. Use it to save memory and improve performance.
  //need to take consideration in the future
  //TODU: modify struct isa and decode. move the below fields to isa
