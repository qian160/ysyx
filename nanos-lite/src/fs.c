...
size_t serial_write2(const void *buf, size_t off, size_t len){
  putch('1');
  return 0;
}
...
static Finfo file_table[] __attribute__((used)) = {
  ...
  [FD_STDOUT] = {"stdout", 0, 0, invalid_read, serial_write2},
  [FD_STDERR] = {"stderr", 0, 0, invalid_read, serial_write2},
#include "files.h"
};
